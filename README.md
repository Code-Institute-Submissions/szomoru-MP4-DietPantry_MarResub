...
-    This project has a lot of possibility to improve and adding extra features. Different features requires different level of knowledge and experience 

        -   Easier features to implement:
            -   Remaining Quantity calculation
            -   Review delete feature
            -   Blog feature to be able to share receipts and experience
            -   Improved form input validation
            -   Nicer messages
        -   More complex features to implement:
            -   Receipt card printer
            -   Automatic Coupon generator based on the Order History
...
9. You will need to create an env.py file
```
import os
...
10. You will also need to install all of the project requirements. This can be done using the command:
    * `pip3 install -r requirements.txt`.
11. Apply database migrations - `python manage.py migrate`
12. Create a superuser - `python manage.py createsuperuser`
13. The project can be run with the following - `python manage.py runserver`
...
-   The core functionality of the Diet Pantry Project is comming from the Boutique Ado Code Institute walkthrough project
...
-   [Django Documentation](https://docs.djangoproject.com/en/3.2/): good quality documentation with deep explanations


### **7-2 Content**

-  The descriptions of the products are comming form the manufacturers website.
-   The different diet descriptions and informations are comming from 2 sites:
    -   [Diet Doctor](https://www.dietdoctor.com)
        One of the biggest Low Carb / Keto website with tons of receipts
    -   [Healthline](https://www.healthline.com)
        Evrything about health. Lovely page in the field of healthy lifestyle
    
    The source link is placed on the left bottom corner on each paragraph.
...
-   I have also taken inspiration from the following fellow students projects:
    -   Harry Leepz: [Nourish and lift](https://nourish-and-lift.herokuapp.com/)
        
    -   Russ Oakham: [Immortal Fitness](https://immortal-fitness-collective.herokuapp.com/)
    -   Juan Stelling: [PRNTS](https://ms4-prnts.herokuapp.com/) 
  

### **7-3 Media**

- The product images and descriptions are comming from the product manufacturers webpage:
    -   [Quest Nutrition](https://www.questnutrition.com)
    -   [Nicks Swedish](https://www.nicks.se)
    -   [Nicks Global](https://www.nicks.com)
    -   [Sukrin](https://www.sukrin.com)
    -   [Bulk](https://www.bulk.com)
    -   Almond butter / Avocado Oil / MCT Oil images and descriptions [Hälsokost](https://www.svenskhalsokost.se/)
- The hero images on the main page:
    -   [Gut Health](https://www.medicalnewstoday.com/articles/321821)
    -   [Long Life](https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/gettyimages-1030661702.png?crop=0.668xw:1.00xh;0.259xw,0&resize=980:*
)
    -   [Energetic Life](https://www.pinterest.co.uk/pin/528680443730189577/)
    -   [Healthy Skin](https://justinhealth.com/5-steps-to-create-super-healthy-skin-podcast-74/)

### **7-4 Acknowledgements**

-   My Mentor: **Precious Mentor** for helpful and fast feedbacks.
-   **Chris Zielinski** who is the creator of the Boutique Ado walkthrough project. Huh, I wish i would know only 10% what he knows :) Really good job from him 
-   Thanks to the Assessor who highlighted a lot of problems with my project. I fully agree with the previous FAIL grade
-   Thanks to my family specially my wife who taken over our 4 kids while i was doing my studies and also suppirted on thsi long-long journey
